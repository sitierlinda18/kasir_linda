...
<html lang="en">
  ...
  <a class="navbar-brand col-md-3 col-lg-2 mr-0 px-3" href="#">Aplikasi Kasir Toko Putra Putri</a>
    ...
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="sidebar-sticky pt-3">
        <ul class="nav flex-column">
          <li class="nav-item">
            <a class="nav-link active" href="https://id.pinterest.com/pin/806355508286088352/">
